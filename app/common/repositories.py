...
class Message(BaseEntity):
    ...
    sender_id: Mapped[uuid.UUID] = mapped_column(PG_UUID(as_uuid=True), nullable=False, doc="ID of the User who sent the Message")
    role: Mapped[str] = mapped_column(nullable=False, doc="Role of the sender (e.g., user, assistant)")
    ...
    message_embeddings: Mapped[list[float]] = mapped_column(Vector(1536), nullable=True, doc="Embeddings of the Message content for search and retrieval")
