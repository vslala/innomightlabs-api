...
class UserEntity(BaseEntity):
    ...
    updated_at: Mapped[datetime] = mapped_column(nullable=False, default=datetime.now(timezone.utc), onupdate=datetime.now(timezone.utc), doc="Timestamp when the Conversation was last updated")
